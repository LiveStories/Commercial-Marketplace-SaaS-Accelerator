...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221118045814_Baseline_v2')
BEGIN
...
BEGIN
    ...
    VALUES 
        ('Int','11/15/2023 8:46:54 PM','int'),
        ('String','11/15/2023 8:46:54 PM','string'),
        ('Date','11/15/2023 8:46:54 PM','date')
...
BEGIN
    ...
    VALUES
        ('Activate',1,'11/15/2023 8:46:54 PM'),
    	('Unsubscribe',1,'11/15/2023 8:46:54 PM'),
    	('Pending Activation',1,'11/15/2023 8:46:54 PM')
...
BEGIN
    ...
    VALUES
        ('Failed','Failed','11/15/2023 8:46:54 PM', '
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
    	...
    	('PendingActivation','Pending Activation','11/15/2023 8:46:54 PM', '
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">  
    <html xmlns="http://www.w3.org/1999/xhtml">
       <head>
          <!--<note>Use this Template for Pending Activation email </note>-->      
    ...
    ','Pending Activation',1),
    	('Subscribed','Subscribed','11/15/2023 8:46:54 PM', '
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">  
    <html xmlns="http://www.w3.org/1999/xhtml">
       <head>
          <!--<note>Use this Template for Pending Activation email </note>-->      
    ...
    ','Subscribed',1),
    	('Unsubscribed','Unsubscribed','11/15/2023 8:46:54 PM', '
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">  
    <html xmlns="http://www.w3.org/1999/xhtml">
       <head>
          <!--<note>Use this Template for Pending Activation email </note>-->      
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221118203340_Baseline_v5')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221118203340_Baseline_v5', N'6.0.1');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221118211554_Baseline_v6')
BEGIN
